...
internal static class PropertyMarketplaceTests
{
    public static int Run()
    {
        ...
        {
            command.CommandText = "CREATE TABLE Regions (Id INTEGER PRIMARY KEY AUTOINCREMENT, RegionName TEXT NOT NULL, WorldID TEXT NOT NULL, Owner TEXT NOT NULL, UserIds TEXT NOT NULL)";
        ...
        var listing = db.CreateMarketplaceListing(property.AssetId, "town", town.TownId, town.TreasuryAccountId, 1_000);
        var held = db.ReserveMarketplaceListing(listing.ListingId, "player", "202", buyerId, escrowId,
            "property-market-reserve-1", TimeSpan.FromMinutes(10), "Property Buyer");

        var sale = db.CompleteTownPropertySale(listing.ListingId, held.ReservationKey, escrowId,
        ...
        var replay = db.CompleteTownPropertySale(listing.ListingId, held.ReservationKey, escrowId,
            202, "PropertyBuyer", 100, taxTreasuryId, "Property Buyer");
        ...
        var rollbackListing = db.CreateMarketplaceListing(rollbackProperty.AssetId, "town", town.TownId, town.TreasuryAccountId, 300);
        var rollbackHeld = db.ReserveMarketplaceListing(rollbackListing.ListingId, "player", "202", buyerId, escrowId,
        ...
        try
        {
            db.CompleteTownPropertySale(rollbackListing.ListingId, rollbackHeld.ReservationKey, escrowId,
